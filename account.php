        ...
        <div class="container account-area">
            ...
            <form id="account_form" name="account_form" class="details-form" method="post" action="account.php">
                ...
                <div class="form-field">
                    ...
                    <input type="text" id="firstname" name="firstname" class="form-control" value="<?php echo $firstname; ?>" tabindex="1">
                    <div class="field-error"><?php echo $firstname_error; ?></div>
                </div>

                <div class="form-field">
                    <label for="lastname">Last Name:*</label>
                    <input type="text" id="lastname" name="lastname" class="form-control" value="<?php echo $lastname; ?>" tabindex="2">
                    <div class="field-error"><?php echo $lastname_error; ?></div>
                </div>

                <div class="form-field">
                    <label for="email">Email:*</label>
                    <input type="email" id="email" name="email" class="form-control" value="<?php echo $email; ?>" tabindex="3">
                    <div class="field-error"><?php echo $email_error; ?></div>
                </div>

                <div class="form-field">
                    <label for="phone">Phone:*</label>
                    <input type="text" id="phone" name="phone" class="form-control" value="<?php echo $phone; ?>" tabindex="4">
                    <div class="field-error"><?php echo $phone_error; ?></div>
                </div>

                <div class="form-field">
                    <label for="line1">Address Line 1:*</label>
                    <input type="text" id="line1" name="line1" class="form-control" value="<?php echo $line1; ?>" tabindex="5">
                    <div class="field-error"><?php echo $line1_error; ?></div>
                </div>
                <div class="form-field">
                    <label for="line2">Address Line 2:</label>
                    <input type="text" id="line2" name="line2" class="form-control" value="<?php echo $line2;  ?>" tabindex="6">
                </div>

                <div class="form-field">
                    <label for="city">City:*</label>
                    <input type="text" id="city" name="city" class="form-control" value="<?php echo $city; ?>" tabindex="7">
                    <div class="field-error"><?php echo $city_error; ?></div>
                </div>

                <div class="form-field">
                    <label for="province">Province:*</label>
                    <input type="text" id="province" name="province" class="form-control" value="<?php echo $province; ?>" tabindex="8">
                    <div class="field-error"><?php echo $province_error; ?></div>
                </div>

                <div class="form-field">
                    <label for="postal_code">Postal Code:*</label>
                    <input type="text" id="postal_code" name="postal_code" class="form-control" value="<?php echo $postal_code; ?>" tabindex="9">
                ...
                <div class="form-field button-field">
                    <button type="submit" id="submit_button" name="submit_button" class="btn btn-orange" tabindex="10">Update Account</button>
                    <a class="btn btn-pink" href="account.php?delete=true" tabindex="10">Delete Account</a>
                </div>
            </form>
        </div>
    </div>
